...
gcloud compute ssl-certificates create web-ssl-cert-$(date +%Y-%m-%d) --certificate /etc/letsencrypt/live/wowsofun.com/fullchain.pem --private-key /etc/letsencrypt/live/wowsofun.com/privkey.pem
