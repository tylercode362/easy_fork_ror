...
set :repo_url, "git@bitbucket.org:tylerliu362/common_ror_docker.git"
...
#set :whenever_command,      ->{ [:bundle, :exec, :whenever, "-i"] }
...
set :puma_bind,       "unix://#{shared_path}/tmp/sockets/basic-puma.sock"
